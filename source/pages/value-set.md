...
## Value set
![value-set-main.png](files/wiki/value-set-main.png){width=600}
...
![value-set-version-edit.png](files/wiki/value-set-version-edit.png){width=600}
...
![value-set-rule.png](files/wiki/value-set-rule.png){width=600}

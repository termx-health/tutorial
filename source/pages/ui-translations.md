...
1. Navigate to the `termx-web/src/assets/i18n` folder in [TermX Web](https://github.com/termx-health/termx-web/tree/main/app/src/assets/i18n). 
...
*Ensure the existence of your translations in [Core Utils](https://github.com/termx-health/utils/tree/main/core-util/lib/locales) and the [Marina](https://github.com/termx-health/marina/tree/main/modules/ui/src/locales) project.*
